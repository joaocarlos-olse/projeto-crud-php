<?php
    ...
    if(isset($_SESSION['relatorio_pedidos'])){
        $pedidos = $_SESSION['relatorio_pedidos'];
        unset($_SESSION['relatorio_pedidos']);
    }
    else{
    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="titulo-clientes">
                <h1 class="texto-vermelho">RELATÓRIO - CADASTRO DE PEDIDOS</h1>
            </div>
        </header>
        <main class="main">
